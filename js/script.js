...
function getExchangeRate() {
  ...
  exchangeRateTxt.innerText = "wait fess...";
  let url = `https://v6.exchangerate-api.com/v6/60e49377fb2ad282c9d5aaf4/latest/${fromCurrency.value}`;
  ...
  fetch(url)
    ...
    .catch(() => {
      ...
      exchangeRateTxt.innerText = "wetin happen again?";
    });
}
